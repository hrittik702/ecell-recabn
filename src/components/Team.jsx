...
const Team = () => {
  ...
  return (
    <section ref={containerRef} id="team" className="py-24 relative z-10 bg-off-white overflow-hidden">
      
      {/* Decorative Blob */}
      <div className="absolute top-40 left-0 w-[400px] h-[400px] bg-purple-50 rounded-full blur-3xl opacity-60 -z-10 -translate-x-1/2" />
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="team-header flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-display font-bold text-gray-900 tracking-tight">Meet the Team</h2>
          </div>
        ...
        <div className="min-h-[600px]">
          {filteredTeam.current.length > 0 && (
            <div className="mb-16 animate-fade-in">
              <div className="mb-6 flex items-center">
                <h3 className="text-xl md:text-2xl font-display font-bold text-gray-900 mr-4">Current Team</h3>
          ...
          {filteredTeam.passout.length > 0 && (
            <div className="animate-fade-in">
              <div className="mb-6 flex items-center">
                <h3 className="text-xl md:text-2xl font-display font-bold text-gray-900 mr-4">Passout Seniors</h3>
                <div className="flex-1 h-px bg-gray-200/80" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
